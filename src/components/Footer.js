    ...
    return(
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={6} lg={4} style={{textAlign:'center'}}>
            ...
            NAFOWA National Secretariat
            No. 4 Dame Patience Goodluck Jonathan Road, Behind Command Guest House, 
            After State House Clinic, 
            Asokoro – Abuja, Federal Capital Territory
            Nigeria, West Africa 
            </div>
            <h2>Social Media</h2>
            <div>
        ...
        <Typography style={{textAlign:'center',marginTop:'50px', color:'#1565c0'}}>
           <p> Copyright &#169; {year} NAFOWA</p>
        </Typography>
    </Container>
    )
}
